...
class Obstacle(pg.sprite.Sprite):
    ...
    def __init__(self):
        ...
        pg.draw.circle(self.image, (0, 150, 150), (rad, rad), rad)
        self.image.set_colorkey((0, 0, 0)) # 岩の色変更、黒い部分を透明に
